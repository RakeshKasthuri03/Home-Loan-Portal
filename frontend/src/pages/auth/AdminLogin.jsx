    ...
    <div style={{ minHeight: "100vh", background: "#f4f6fb", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Inter, Poppins, sans-serif" }}>
      <div style={{ background: "#fff", borderRadius: "16px", padding: "40px 48px", width: "100%", maxWidth: "420px", boxShadow: "0 8px 32px rgba(15,37,87,0.10)" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "28px" }}>
          ...
          <h2 style={{ margin: 0, fontSize: "1.3rem", fontWeight: 800, color: "#0f2557" }}>Admin Portal</h2>
          <p style={{ margin: "4px 0 0", fontSize: "0.85rem", color: "#6b7280" }}>Sign in to manage the platform</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            style={{ width: "100%", padding: "11px", background: "#0f2557", color: "white", border: "none", borderRadius: "8px", fontSize: "0.95rem", fontWeight: 700, cursor: "pointer", fontFamily: "inherit", opacity: loading ? 0.7 : 1 }}
          >

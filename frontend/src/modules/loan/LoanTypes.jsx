        ...
        <div className="loan-container">
          <div className="loan-card-info">
            ...
            <section className="table-wrapper">
              ...
              <p><span className="required-star">*</span> Borrower is required to pay subsequent PEMIs at the end of each respective month and shall in any case pay on or before the 5th of the following month.</p>
            </section>
            ...
            <section className="classification-wrapper">
              ...
              <div className="classification-body">
                <ol className="classification-list">
                  ...
                  <li>All total overdues should be paid by the borrower on or before the due date of the payment. Failing which the account would be downgraded in accordance with the RBI guidelines as explained above.</li>
                  <li>Once the loan is classified as an NPA, it shall remain so until and unless the entire full overdue amount has been paid.</li>
                  <li>The Account can be upgraded to a standard classification on payment of entire overdues in full.</li>

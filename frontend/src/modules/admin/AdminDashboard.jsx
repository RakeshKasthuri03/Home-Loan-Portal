        ...
        <main className="dashboard-content">
          ...
          <div className="loan-config-section">
            ...
            <table className="loan-config-table">
              ...
              <tbody>
                <tr>
                  <td><span className="loan-dot blue"></span> Home loan</td>
                ...
                <tr>
                  <td><span className="loan-dot green"></span> Plot loan</td>
                ...
                <tr>
                  <td><span className="loan-dot orange"></span> Renovation loan</td>
                ...
                <tr>
                  <td><span className="loan-dot purple"></span> NRI loan</td>
